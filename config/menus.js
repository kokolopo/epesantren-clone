        ...
        child: [
          {
            title: "Kelas",
            icon: Monitor,
            href: "/kesantrian/kelas",
          },
          {
            title: "Kamar",
            icon: Home,
            href: "/kesantrian/kamar",
          },
          {
            title: "Santri",
            icon: User,
            href: "/kesantrian/santri",
          },
          {
            title: "Tahfidz",
            icon: BookIcon,
            href: "/kesantrian/tahfidz",
          },
          {
            title: "Nadhoman",
            icon: Book,
            href: "/kesantrian/nadhoman",
          },
          {
            title: "Pengumuman",
            icon: Mail2,
            href: "/kesantrian/pengumman",
          },
          {
            title: "Setting RFID",
            icon: Settings,
            href: "/kesantrian/setting-rfid",
          },
        ],
      },
      {
        ...
        child: [
          {
            title: "Akademik",
            href: "/plugin/akademik",
            icon: GraduationCap,
          },
          {
            title: "Kepegawaian",
            href: "/plugin/kepegawaian",
            icon: UserSquare,
          },
          {
            title: "halaqoh",
